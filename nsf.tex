...
\bibitem{affleck} Affleck, Ian, and Elliott H. Lieb. "A proof of part of Haldane's conjecture on spin chains." Condensed Matter Physics and Exactly Soluble Models. Springer, Berlin, Heidelberg, 1986. 235-247.
...
\bibitem{ercolessi} Ercolessi, Elisa, et al. "Phase transitions in $\mathbb Z_n$ gauge models: Towards quantum simulations of the Schwinger-Weyl QED." Physical Review D 98.7 (2018): 074503.
...
\bibitem{horn} Horn R. A., Johnson C. R. Matrix analysis. - Cambridge university press, 2012.
\bibitem{israel} Israel, Robert B. Convexity in the theory of lattice gases. Vol. 64. Princeton University Press, 2015.
\bibitem{kato} Kato, Tosio. Perturbation theory for linear operators. Vol. 132. Springer Science \& Business Media, 2013.
\bibitem{landau} Landau, Lev Davidovich, and Evgenii Mikhailovich Lifshitz. Quantum mechanics: non-relativistic theory. Vol. 3. Elsevier, 2013.
\bibitem{rellich} Rellich, Franz, and Joan Berkowitz. Perturbation theory of eigenvalue problems. CRC Press, 1969.
\bibitem{miller} Representation Theory and Quantum Mechanics (unpublished notes that can be found on the Internet)
...
\bibitem{woit} Woit, Peter, Woit, and Bartolini. Quantum theory, groups and representations. Springer International Publishing, 2017.
\end{thebibliography}
\end{document}